...
namespace Graphics {
  ...
  void ViewMatrix::ortho(float left, float right, float bottom, float top, float near, float far)
  {
  ...
  void ViewMatrix::Perspective(float fovy, float aspect, float near, float far)
  {
